...
FLIRT_TXTFILECORRATIO="/home/bdivdi.local/dfgtyk/NVROXBOX/EXE/FSL/fnirt/tests/T1-2-MNI-OnlyFLIRT-CORRATIO.txt"
rm -rf ${FLIRT_TXTFILECORRATIO}

STANDARDDIR=$FSLDIR/data/standard/MNI152_T1_2mm_brain.nii.gz

for SubIDX in 1 # $(seq 1 2)
do
	echo $SubIDX

	SubSesID=$(sed "${SubIDX}q;d" failed_flirt.txt)
