...
do
	...
	SubSesID=$(sed "${SubIDX}q;d" failed_fnirt.txt)
...
####################### FNIRT
	...
	FNIRTSuffix="${FLIRTSuffix}_FNIRT-FNIRTCHECK-infwhm4300-reffwhm4300-lambda50302010-sbsmpl1111-T1-2-MNI152-2mm-cnf"
...
#--config=$FSLDIR/etc/flirtsch/T1_2_MNI152_2mm.cnf \
	...
	--refmask=$refmask \
	--config=FNIRTCHECK_infwhm4300-reffwhm4300-lambda50302010-sbsmpl1111_T1_2_MNI152_2mm.cnf
...
#	CORRATIO_FNIRT=$(sh /home/bdivdi.local/dfgtyk/NVROXBOX/SOURCE/NVR-OX-IMGSIM.sh "${OutputDir}/T1_to_MNI_nonlin_${FNIRTSuffix}.nii" "${STANDARDDIR}")
