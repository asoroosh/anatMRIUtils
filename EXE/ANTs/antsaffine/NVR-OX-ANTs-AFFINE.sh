...
JobName=${StudyID}_${DirSuffix}_affine_${NUMJB}
...
#Register everything back to the MNI -- mainly for quality check
...
--input \${OutputDir}/antsCorticalThickness/\${ImageName}.nii.gz \\
--transform \${OutputDir}/MNI/\${OutputPrefix}_2mm_\${ImageName}_0GenericAffine.mat \\
--output \${OutputDir}/MNI/\${ImageName}_MNI_2mm_affine.nii.gz \\
--verbose 1
