...
#SBATCH --output=/home/bdivdi.local/dfgtyk/NVROXBOX/EXE/subtemplates/subsamplingtests/logs/antsSST_100x70x30x3_%A_%a.out
#SBATCH --error=/home/bdivdi.local/dfgtyk/NVROXBOX/EXE/subtemplates/subsamplingtests/logs/antsSST_100x70x30x3_%A_%a.err
#SBATCH --array=1-1
