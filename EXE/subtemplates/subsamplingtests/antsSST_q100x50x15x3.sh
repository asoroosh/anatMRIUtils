...
#SBATCH --output=/home/bdivdi.local/dfgtyk/NVROXBOX/EXE/subtemplates/subsamplingtests/logs/antsSST_100x50x15x3_%A_%a.out
#SBATCH --error=/home/bdivdi.local/dfgtyk/NVROXBOX/EXE/subtemplates/subsamplingtests/logs/antsSST_100x50x15x3_%A_%a.err
#SBATCH --array=1-6
