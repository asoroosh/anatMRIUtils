...
#SBATCH --output=/home/bdivdi.local/dfgtyk/NVROXBOX/EXE/subtemplates/subsamplingtests/logs/antsSST_60x30x3_%A_%a.out
#SBATCH --error=/home/bdivdi.local/dfgtyk/NVROXBOX/EXE/subtemplates/subsamplingtests/logs/antsSST_60x30x3_%A_%a.err
#SBATCH --array=1-7
