...
#---------------------------
	...
	SEGDIR=${PRSD_DIR}/${StudyID}/sub-${SubID}/ses-${SesID}/anat/sub-${SubID}_ses-${SesID}_${SEGOP}_BETsREG_2tissues_brain_rawavg
	SEGIMG=${SEGDIR}/sub-${SubID}_ses-${SesID}_${SEGOP}_BETsREG_brain_rawavg_denoised_N4_2tissues_pve_1.nii.gz
...
#---------------------------
# Segmnetation file from FAST 2 tissues segmentations
# With a background image as a raw image
...
#---------------------------
# Segmentation file from FAST 3 tissues segmentation
# With a background image as a raw image

	PNGIMGNAME_RAWBE=${SubID}_${SesID}_SEG1onRAW_core

	SEGDIR=${PRSD_DIR}/${StudyID}/sub-${SubID}/ses-${SesID}/anat/sub-${SubID}_ses-${SesID}_${SEGOP}_brain_rawavg
	SEGIMG=${SEGDIR}/sub-${SubID}_ses-${SesID}_${SEGOP}_brain_rawavg_denoised_N4_seg_1.nii.gz
