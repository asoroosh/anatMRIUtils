...
do
	...
	ImageFileTxt=${ImgTypDir}/Sessions/${StudyID}_FullSessionSubID_${ImgTyp}.txt
...
#	echo ${WhereTheStatFilesAre}
	Path2StatFile=${WhereTheStatFilesAre}/${StudyID}_${LT_DirSuffix}_${DirSuffix}_${NUMJB}_*_*.stat
...
#	echo ${Path2StatFile}
	...
	do
		Path2StatPerFile=${WhereTheStatFilesAre}/${StudyID}_${LT_DirSuffix}_${DirSuffix}_${NUMJB}_*_${i_NUMJB}.stat
