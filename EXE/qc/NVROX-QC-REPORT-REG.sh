...
QCType_List=(PASSED TENTATIVE LINFAILED LINCHECK NONLINFAILED NONLINCHECK)
...
ImageNameList=(T1_to_MNI_lin-T1_to_MNI_nonlin BrainExtractionBrain_MNI_2mm_affine-BrainExtractionBrain_MNI_2mm)

while read StudyIDClean
do
	echo "== $StudyIDClean ====================================="
	for FileName_cnt in 0 1
	do
