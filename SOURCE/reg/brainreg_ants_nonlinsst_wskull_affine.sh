...
echo "Mask: ${NonLinSSTDirImg_mask}.nii.gz"
...
--output [${antsRegOutputPrefix}AFFINE,${antsRegOutputPrefix}AFFINE.nii.gz] \
--interpolation Linear \
--use-histogram-matching 1 \
--winsorize-image-intensities [0.005,0.995] \
--initial-moving-transform [${MNIImg_FS}.nii.gz,${NonLinSSTDirImg}.nii.gz,1] \
--transform Rigid[0.1] \
--metric CC[${MNIImg_FS}.nii.gz,${NonLinSSTDirImg}.nii.gz,1,10] \
...
--shrink-factors 12x8x4x2 \
--smoothing-sigmas ${SmthFctrs} \
#-x [${MNIImg_FS}_mask.nii.gz,${NonLinSSTDirImg_mask}.nii.gz]
