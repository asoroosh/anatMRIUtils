...
SEG_LOG=${PVE_Suboutdir}/sub-${SubID}_${OpDirSuffix}_brain_rawavg.log
...
SegOutPrefix=${PVE_Suboutdir}/sub-${SubID}_ses-${SesID}_${OpDirSuffix}_brain_rawavg_denoised_N4
...
if [ $do_seg == 1 ]; then
	...
	${FSLDIR}/bin/fast -n 3 \
	-A ${TissuePriors}/sub-${SubID}_ses-${SesID}_avg152T1_gray_${SegOrFlg}_rawavg.nii.gz \
	${TissuePriors}/sub-${SubID}_ses-${SesID}_avg152T1_white_${SegOrFlg}_rawavg.nii.gz \
	${TissuePriors}/sub-${SubID}_ses-${SesID}_avg152T1_csf_${SegOrFlg}_rawavg.nii.gz \
	-I 4 \
	-p \
	-b \
	-B \
	-g \
	-o ${PVE_Suboutdir}/sub-${SubID}_ses-${SesID}_${OpDirSuffix}_brain_rawavg_denoised_N4 \
